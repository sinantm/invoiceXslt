					...
					<xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'IS_INTERNET']">
						<div id="internetSatis" style="margin-top:5px">
							<table class="notesTable" width="800" align="left" height="50" cellpadding="2"
								...
								<tbody>
									<th>Bu satış internet üzerinden yapılmıştır</th>
									<tr>
			                ...
			                <tr>
			                	<td>
			                		<xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'IS_DESPATCH']">
			                			<strong>Not:</strong> İrsaliye yerine geçer
			                		</xsl:for-each>
			                	</td>
			                </tr>
						    <tr>
						    	<td>
						    		<table width="800" align="left" height="50" cellpadding="2"
						    			cellspacing="2"
						    			style="margin-top:10px;margin-bottom:30px;width:800px;text-align:left;">
						    			<tbody>
						    				<tr style="text-align:center">
						    					<td id="notesTableTd" colspan="5" style="font-weight:bold">İade Edilen Mal Bilgileri</td>
						    				</tr>
						    				<tr style="border:0px">
