						...
						<tbody>
							...
							<tr>
								...
								<td style="width: 300px;">
									...
									<div class="firma_adi">
										<xsl:call-template name="printGonderici"/>
									</div>
								...
								<td>
									<div>
										...
										<div class="earsiv_text" style="font-weight: bold;">e-Arşiv Fatura</div>
									</div>
									<div>
                                        <div class="signature_logo_container" style="margin-top: 10px; margin-left:10px;">
                                            {{IMZA}}
                                        </div>
                                    </div>
								</td>
...
-->
	...
	<xsl:template name="printMusteriAdi">
		...
		<xsl:template name="printGonderici">
		<xsl:choose>
			<xsl:when
				test="//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName and //n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name and string-length(//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name) &gt; 2">
				<xsl:value-of
					select="//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PartyName/cbc:Name"
				/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:for-each select="//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Person">
					<div>
						<xsl:value-of
							select="//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Person/cbc:FirstName"/>
						<xsl:text>&#160;</xsl:text>
						<xsl:value-of
							select="//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Person/cbc:MiddleName"/>
						<xsl:text>&#160;</xsl:text>
						<xsl:value-of
							select="//n1:Invoice/cac:AccountingSupplierParty/cac:Party/cac:Person/cbc:FamilyName"
						/>
					</div>
				</xsl:for-each>
			</xsl:otherwise>
