            ...
            <tbody>
              <tr valign="top">
                ...
                <td style="width:140px;" valign="center" align="center" rowspan="2" cellspacing="2px" cellpadding="2px">
                  <img style="width:91px;" align="middle" alt="e-Arşiv Logo"
          ...
          <xsl:for-each select="//n1:Invoice/cac:AdditionalDocumentReference[cbc:DocumentTypeCode = 'IS_INTERNET']">
            ...
            <div id="internetSatis" style="margin-top:5px">
              <table style="border:1px solid orange; border-collapse: collapse;" cellspacing="0px"
                ...
                <tbody>
                  <tr>
                    <td style="border-bottom:1px dotted orange; border-right:1px solid orange; font-size:8px;"
                      align="center">
                      &#160;&#160;Web Adresi
                    </td>
                    <td style="border-bottom:1px dotted orange; border-right:1px solid orange; font-size:8px;"
              ...
              <table style="border:1px solid orange; border-collapse: collapse; margin-top:10px;" cellspacing="0px"
                width="800" cellpadding="0px">
                <tbody>
